...
#define WEAP_AK42               13
#define WEAP_CHAINSAW           14
#define WEAP_CROSSBOW           15
#define WEAP_PCROSSBOW          16
#define WEAP_ECROSSBOW          17
#define WEAP_ESUPERSHOTGUN      18
#define WEAP_AIRFIST            19
#define WEAP_FGRENADES          20
#define WEAP_LMINES             21
#define WEAP_PGRENADES          22
#define WEAP_PMINES             23
#define WEAP_FGRENADELAUNCHER   24
...
#define	FOFS(x) (long int)&(((edict_t *)0)->x)
#define	STOFS(x) (long int)&(((spawn_temp_t *)0)->x)
#define	LLOFS(x) (long int)&(((level_locals_t *)0)->x)
#define	CLOFS(x) (long int)&(((gclient_t *)0)->x)
...
struct gclient_s
{
	...
	qboolean	showgrenade;			// show or not grenades
	qboolean	showarrow;			// show or not arrows
   	qboolean    showfrag;
//ZOID
