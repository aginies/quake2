...
cvar_t	*start_grapple, *start_defenceturret, *start_rocketturret, 
		...
		*start_ammo_flashgrenades, *start_ammo_lasergrenades, *start_ammo_c4,
...
gitem_t	*it_shells, *it_eshells, *it_cells, *it_arrows, *it_rockets, 
		*it_homings, *it_slugs, *it_buzzes, *it_grenades, *it_c4,
		...
		*it_buzzsaw, *it_hyperblaster, *it_bfg, *it_dual,
